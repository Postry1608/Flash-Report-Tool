...
with st.form("flash_report_form", clear_on_submit=False):
    ...
    # Static field inside form to avoid layout errors
    other_type_detail = st.text_input(
        "If selected 'Hazard / Other', please specify details:",
...
if submit_button:
    ...
    # Require details if 'Hazard / Other' is picked
    if incident_type == "Hazard / Other":
        required_fields["'Other' Incident Type Detail"] = other_type_detail
    ...
    if missing_fields:
        ...
        def generate_pdf():
            ...
            # Format incident display string
            display_type = incident_type
            if incident_type == "Hazard / Other" and other_type_detail.strip():
                display_type = f"Hazard / Other ({other_type_detail.strip()})"
            ...
            meta_data = [
                ...
                [
                    ...
                    Paragraph(display_type, body_style),
